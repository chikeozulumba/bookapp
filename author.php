...
if (isset($_GET['add'])) {
  ...
  <div class="container" style="font-family: 'Trirong', serif;">
    ...
    <div class="col-md-10"  id="login-form">
      ...
      <form style="padding-top: 10px;"  method="post" action="author_reg.php" target="">
        ...
        <div class="col-md-6 text-right form-group" style="margin-top: 19px;">
          <button  href="author.php" class="btn btn-md btn-warning gradient">Cancel</button>
          <input  class="btn btn-md btn-success gradient" type="submit" value="Sign Up >>"><br>
        </div>
  </div>
  </form>
  </div>
 ...
 ?>
<div style="font-family: 'Trirong', serif;" class="container">
<h1 class="text-center page-header" >Author Registration</h1>
<div class="col-md-3">

</div>
<div class="col-md-7">
  <p>
        CEPA-Bookshop serves as an online retail system for books and other literary materials, presenting an avenue for Authors
    to advertize their books for sale. <br>    Our system assists prospective buyers in locating books that suit their demands and by registering as an author on CEPA-Bookshop, You are afforded the oppourtunity of improving the sales and coverage of your books with us.
  </p>
  <h3 class="text-center page-header">Pricing</h3>
  <p>
    Author subscription is on yearly basis, resulting in the payment of 5,000 NGN.<br>
    Book registration is as follows:
    <table class="table table-bordered table-stripped table-condensed">
      <thead><th>Category</th><th>Plan</th><th>Price charge</th><th>Validity period</th></thead>
      <tbody>
        <td>CEPA-Fast</td>
        <td>Less than 5 books</td>
        <td>3,000 NGN</td>
        <td>6 months</td>
      </tbody>
      <tbody>
      ...
      <tbody>
        <td>CEPA-Grow</td>
        <td> 16 books and above</td>
        <td>15,000 NGN</td>
        <td>1 Year</td>
      </tbody>
    </table>
    Other associated charges like special adverts, bulk processing, front-page view, customer invoicing attract additional charges.
  </p>
  <p>
    Our support centers are up and running 24/7, for assistance with any difficulties you encounter.
  </p>
  <br>
  <a class="btn btn-md btn-info gradient text-center"  href="author.php?add=1">Proceed >></a>
</div>
