  ...
  <div class="row">
    ...
    <?php if ($cart_id == ''):?>
      <div class="alert alert-danger">
        <p style="font-family: 'Trirong', serif;" class="text-center text-danger">Your shopping cart is empty!<a href="index.php"> Back to Home Page</a></p>
      </div>
    <?php else: ?>
            ...
            foreach ($items as $item) {
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-xs btn-default" onclick="update_cart('removeone','<?=$product['id'];?>','<?=$item['format'];?>');">-</button>
                    <?=$item['quantity'];?>
                    <?php if($item['quantity'] < $available):?>
                      <button type="button" class="btn btn-xs btn-default" onclick="update_cart('addone','<?=$product['id'];?>','<?=$item['format'];?>');">+</button>
                    <?php else: ?>
      ...
      <table class="table table-bordered table-condensed text-right">
        ...
        <tbody style="font-family: 'Rakkas', cursive;">
          <tr>
            ...
            <td><?=money($tax);?></td>
            <td class="bg-success" readonly><?=money($sub_total + ($sub_total * 0.05));?></td>
          </tr>
        </tbody>
      </table>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                ...
                <form id="payment-form" action="create_payment.php" method="post">
                  ...
                  <input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count>1)?'s':'').' from CepaBooks';?>">
            ...
            <div class="modal-footer">
              ...
              <button style="font-family: 'Rakkas', cursive;" type="submit" class="btn btn-primary btn-md outline">Proceed >></button>
            </form>
            </div>
          </div>
        </div>
